...
function cloneRepo() {
	...
	cmd.get(
		'rm -rf starter-node-angular && git clone https://github.com/cymun111/starter-node-angular.git',
...
function restartRemoteServices() {
	return ssh.execCommand('ssh -i my-key.pem ubuntu@18.219.79.59 "bash -s" < sudo service mongod start && npm start', { cwd:'/home/ubuntu/starter-node-angular' })
}
